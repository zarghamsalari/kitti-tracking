...
- [ ] **T5 — Tracker #1: ByteTrack.** Wire ByteTrack on top of saved detections. Tune `track_thresh`, `match_thresh`, `track_buffer` (≤5 trials on val). Output `runs/track/bytetrack/`.
